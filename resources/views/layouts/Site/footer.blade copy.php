...
<div class="row pre-footer"></div>
<footer class="text-center text-lg-start text-white" style="background-color: #9ecf5c">
    <!-- Grid container -->
        ...
        <section class="">
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                    <h6 class="text-uppercase mb-4 font-weight-bold">Menu do Site</h6>
                    <p>
                        <a class="text-white" href="#">Programe sua coleta</a>
                    </p>
                    <p>
                        <a class="text-white" href="#">Solicite um orçamento</a>
                    </p>
                    <p>
                        <a class="text-white" href="{{ url('/') }}/envie-sua-amostra">Envie sua amostra</a>
                    </p>
                    <p>
                        <a class="text-white">Fale conosco</a>
                    </p>
                </div>
                <!-- Grid column -->
                <hr class="w-100 clearfix d-md-none" />
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                    ...
                    <p><i class="fas fa-home mr-3"></i> {{$endereco->endereco}}{{$endereco->cidade}}/{{$endereco->estado}}</p>
